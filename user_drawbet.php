    ...
    <div class="col-md-7 col-md-offset-1">
        <form action="" method="get">
            <table class="table table-bordered" id="dynamic_field">
                ...
                <tr>
                    <td align="center">
                        <a href="user_drawbet.php?id=<?= $id ?>&&name=<?= $cricket['bet_team1'] ?>&&adminID=<?=$adminID?> ">
                            <?= $cricket['bet_team1'] ?>
                            <br>
                    ...
                    <td align="center">
                        <a href="user_drawbet.php?id=<?= $id ?> && name=<?= $cricket['bet_team2'] ?>&&adminID=<?=$adminID?>">
                            <?= $cricket['bet_team2'] ?>
                            <br>
                    ...
                    <td>
                        ...
                        if (isset($_POST['btn'])){
                            ...
                            elseif ($bet_amount <=0){
                                ...
                                $query = "INSERT INTO `user_beat` (`userbet_id`, `bet_type`, `bet_name`, `bet_amount`, `bet_amount_value`,`status`, `admin_admin_id`,`tbl_users_user_id`, `tbl_betPost_bet_id`) VALUES (NULL, 'draw', '$bet_name', '$bet_amount', '$bet_amount_value','pending','$adminID', '$user_id', '$bet_id');";
