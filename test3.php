...
<?php
    ...
    $query = "INSERT INTO `bet_post` (`bet_id`, `bet_category`, `bet_team1`, `bet_team2`, `bet_name`, `bet_start_time`, `bet_end_time`, `team1_ratio`, `team2_ratio`, `toss_ratio`, `tbl_admin_admin_id`,`player_name`, `player_ratio`, `picture1`, `picture2`) VALUES (NULL, '$category', '$team1', '$team2', '$league_name', '$start_time', '$end_time', '$team1_ratio', '$team2_ratio', '$toss_ratio', '1','$player_name', '$player_ratio', '$img_name1', '$img_name2');";
